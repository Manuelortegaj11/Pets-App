    ...
    public class PetRepository : BaseRepository, IPetRepository
    {
        ...
        public void Edit(PetModel petModel)
        {
            ...
            using (var command = new SqlCommand())
            {
                ...
                command.Parameters.Add("@name", SqlDbType.VarChar).Value = petModel.Name;
                command.Parameters.Add("@type", SqlDbType.VarChar).Value = petModel.Type;
                command.Parameters.Add("@colour", SqlDbType.VarChar).Value = petModel.Colour;
